...
from leroyparser.items import LmparserItem
...
class LmSpider(scrapy.Spider):
    ...
    def parse_goods(self, response: HtmlResponse):
        ...
        loader.add_xpath("priсe", "//span[@slot='price']/text()")
        loader.add_xpath("specific", "//dt[@class='def-list__term']/text()")
        loader.add_xpath("specific_values", "//dd[@class='def-list__definition']/text()")
